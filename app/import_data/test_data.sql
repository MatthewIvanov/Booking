...
('Cosmos Collection Altay Resort', 'Республика Алтай, Майминский район, село Усть-Муны, Лесхозная улица, 20', '["Wi-Fi"]', 20, 1),
('Skala', 'Республика Алтай, Майминский район, поселок Барангол, Чуйская улица, 40', '["Wi-Fi", "Парковка"]', 23, 2),
...
('Bridge Resort', 'посёлок городского типа Sirius, Фигурная улица, 45', '["Wi-Fi", "Парковка", "Кондиционер в номере", "Доступ к бассейну"]', 30, 6);
...
(4, 'Стандарт улучшенный ПЛЮС', 4700, 5, '["Бесплатный Wi-Fi", "Холодильник"]', 14),
